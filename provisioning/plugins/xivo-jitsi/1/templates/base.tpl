...
net.java.sip.communicator.impl.protocol.sip.acc{{ line_no }}.ACCOUNT_UID=SIP\:{{ line['username'] }}@{{ line['proxy_ip'] or sip['proxy_ip'] }}
...
net.java.sip.communicator.impl.protocol.sip.acc{{ line_no }}.SERVER_ADDRESS={{ line['proxy_ip'] or sip['proxy_ip'] }}
net.java.sip.communicator.impl.protocol.sip.acc{{ line_no }}.SERVER_ADDRESS_VALIDATED=true
net.java.sip.communicator.impl.protocol.sip.acc{{ line_no }}.SERVER_PORT={{ line['proxy_port'] or sip['proxy_port']|d(5060) }}
net.java.sip.communicator.impl.protocol.sip.acc{{ line_no }}.SUBSCRIPTION_EXPIRATION=3600
net.java.sip.communicator.impl.protocol.sip.acc{{ line_no }}.USER_ID={{ line['username'] }}@{{ line['proxy_ip'] or sip['proxy_ip'] }}
