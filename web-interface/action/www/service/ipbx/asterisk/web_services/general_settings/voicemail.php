...
//$apptimezone         = &$appvoicemail->get_module('zonemessages');
...
switch($act)
{
	...
	default:
		...
		$info = $appgeneralvoicemail->get_all_val_by_category();

		# /!\ erase appgeneralvoicemail context
		$apptimezone          = &$appvoicemail->get_module('zonemessages');
		$info['zonemessages'] = $apptimezone->get_all_val_by_category();
