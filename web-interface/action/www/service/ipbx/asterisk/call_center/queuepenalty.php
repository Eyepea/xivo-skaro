	...
	case 'add':
		...
		{	
			...
			&& $appqpenalties->add() === true)
				$_QRY->go($_TPL->url('service/ipbx/call_center/queuepenalty'), $param);
...
$menu->set_toolbar('toolbar/service/ipbx/'.$ipbx->get_name().'/call_center/queuepenalty');

$_TPL->set_bloc('main','service/ipbx/'.$ipbx->get_name().'/call_center/queuepenalty/'.$act);
