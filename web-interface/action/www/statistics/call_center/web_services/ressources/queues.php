...
switch($act)
{
	case 'view':
		...
		$appqueue = &$_STS->get_application('queue',null,false);

		if(($info = $appqueue->get($_QRY->get('id'))) === false)
		{
		...
		break;
	case 'add':
		$appqueue = &$_STS->get_application('queue');
		$status = $appqueue->add_from_json() === true ? 200 : 400;
