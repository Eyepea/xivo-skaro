...
switch($act)
{
	case 'add':
		...
		&& dwho_issa('tag', $_QR) === true)
		{
			...
			{
				$_QRY->go($_TPL->url('callcenter/registrationcampaign/tags'), $param);
			}
		}
...
$menu->set_toolbar('toolbar/callcenter/registrationcampaign/tags');

$_TPL->set_bloc('main','callcenter/registrationcampaign/tags/'.$act);
