...
$dhtml->set_css('/extra-libs/ui-timepicker/jquery-ui-timepicker.css', true);
$dhtml->set_js('/extra-libs/ui-timepicker/jquery.ui.timepicker.js', true);
...
$_TPL->set_bloc('main','callcenter/registrationcampaign/general');
