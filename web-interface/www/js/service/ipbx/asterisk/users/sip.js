...
//	'protocol-canreinvite': {it: true, fd: true},
	...
	'protocol-transport': {it: true, fd: true},
	'protocol-directmedia': {it: true, fd: true},
	'protocol-callcounter': {it: true, fd: true},
	'protocol-busylevel': {it: true, fd: true},
	'protocol-ignoresdpversion': {it: true, fd: true},
	'protocol-session-timers': {it: true, fd: true},
	'protocol-session-expires': {it: true, fd: true},
	'protocol-session-minse': {it: true, fd: true},
	'protocol-session-refresher': {it: true, fd: true},
	'protocol-registertrying': {it: true, fd: true},
	'protocol-timert1': {it: true, fd: true},
	'protocol-timerb': {it: true, fd: true},
