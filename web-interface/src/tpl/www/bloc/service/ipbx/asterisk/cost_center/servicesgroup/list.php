...
?>
<form action="#" name="fm-servicesgroup-list" method="post" accept-charset="utf-8">
...
?>
	<tr class="sb-content">
		<td colspan="4" class="td-single"><?=$this->bbf('no_servicesgroup');?></td>
	</tr>
<?php
	else:
		for($i = 0;$i < $nb;$i++):
...
?>
	<tr onmouseover="this.tmp = this.className; this.className = 'sb-content l-infos-over';"
		...
		<td class="td-left">
			<?=$form->checkbox(array('name'		=> 'servicesgroup[]',
						 'value'	=> $ref['id'],
						 'label'	=> false,
						 'id'		=> 'it-servicesgroup-'.$i,
						 'checked'	=> false,
						 'paragraph'	=> false));?></td>
		<td class="txt-left" title="<?=dwho_alttitle($ref['name']);?>">
			<label for="it-servicesgroup-<?=$i?>" id="lb-servicesgroup-<?=$i?>">
<?php
