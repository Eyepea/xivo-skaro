...
?>
<form action="#" name="fm-queueskills-list" method="post" accept-charset="utf-8">
<?php
...
<table id="table-main-listing">
	<tr class="sb-top">
		...
		<th class="th-center"><?=$this->bbf('col_values');?></th>
...
?>
	<tr class="sb-content">
		<td colspan="5" class="td-single"><?=$this->bbf('no_queueskills');?></td>
	</tr>
<?php
	else:
		for($i = 0;$i < $nb;$i++):
...
?>
	<tr onmouseover="this.tmp = this.className; this.className = 'sb-content l-infos-over';"
		...
		<td class="td-left">
			<?=$form->checkbox(array('name'		=> 'queueskills[]',
						 'value'	=> $ref['id'],
						 'label'	=> false,
						 'id'		=> 'it-skills-'.$i,
						 'checked'	=> false,
