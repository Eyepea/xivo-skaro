...
dwho.dom
		.set_onload(function() {
			if (typeof (xivo_toolbar_fm_search) === 'undefined'
					|| dwho_has_len(xivo_toolbar_fm_search) === false)
			...
			dwho.dom.add_event('mouseover', dwho_eid('toolbar-add-menu'),
					function() {
						this.style.display = 'block';
					});

			dwho.dom.add_event('mouseout', dwho_eid('toolbar-add-menu'),
					function() {
			...
			dwho.dom.add_event('mouseover', dwho_eid('toolbar-advanced-menu'),
					function() {
						this.style.display = 'block';
					});

			dwho.dom.add_event('mouseout', dwho_eid('toolbar-advanced-menu'),
					function() {
						this.style.display = 'none';
					});
			...
			dwho.dom.add_event('click',
					dwho_eid('toolbar-advanced-menu-select-all'), function(e) {
						if (dwho_is_function(e.preventDefault) === true)
							e.preventDefault();
