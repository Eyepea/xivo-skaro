...
?>
<form action="#" name="fm-iproute-list" method="post" accept-charset="utf-8">
<?php
...
<table id="table-main-listing">
	<tr class="sb-top">
		...
		<th class="th-center"><?=$this->bbf('col_iface');?></th>
		<th class="th-center"><?=$this->bbf('col_destination');?></th>
		<th class="th-center"><?=$this->bbf('col_netmask');?></th>
...
?>
	<tr class="sb-content">
		<td colspan="8" class="td-single"><?=$this->bbf('no_iproute');?></td>
	</tr>
<?php
	else:
		for($i = 0;$i < $nb;$i++):
...
?>
	<tr onmouseover="this.tmp = this.className; this.className = 'sb-content l-infos-over';"
		...
		<td class="td-left">
			<?=$form->checkbox(array('name'		=> 'iproute[]',
						 'value'	=> $ref['id'],
						 'label'	=> false,
						 'id'		=> 'it-iproute-'.$i,
						 'checked'	=> false,
