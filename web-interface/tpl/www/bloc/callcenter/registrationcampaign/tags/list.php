...
?>
<form action="#" name="fm-callcenter-tags-list" method="post" accept-charset="utf-8">
<?php
...
<table id="table-main-listing" cellspacing="0" cellpadding="0" border="0">
	<tr class="sb-top">
		...
		<th class="th-center"><?=$this->bbf('col_label');?></th>
		<th class="th-center"><?=$this->bbf('col_tagaction');?></th>
...
?>
	<tr class="sb-content">
		<td colspan="6" class="td-single"><?=$this->bbf('no_tags');?></td>
	</tr>
<?php
	else:
		for($i = 0;$i < $nb;$i++):
...
?>
	<tr onmouseover="this.tmp = this.className; this.className = 'sb-content l-infos-over';"
		...
		<td><?= $ref['name'] ?></td>
		<td><?= $ref['label'] ?></td>
		<td><?= $this->bbf('fm_tag_action-opt('.$ref['action'].')') ?></td>
