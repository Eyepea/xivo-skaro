...
<script type="text/javascript">
	/* <![CDATA[ */
		$(document).ready(function() {
				  $('#it-purge_syst_tagged_at').timepicker({showPeriodLabels: false});
				  $('#it-purge_syst_untagged_at').timepicker({showPeriodLabels: false});
				  $('#it-purge_punct_at').timepicker({showPeriodLabels: false});
			});
	/* ]]> */
</script>
</div>
