...
<?php
	echo	$form->text(array('desc'	=> $this->bbf('fm_campaign_name'),
				  ...
				  'size'	=> 15,
				  'default'	=> $this->get_var('element','campaign','name','default'),
				  'value'	=> $this->get_var('info','campaign','name'),
		    ...
		    $form->checkbox(array('desc'	=> $this->bbf('fm_campaign_occasional'),
		      ...
		      'labelid'		=> 'campaign_occasional',
				  ...
				  'required'	=> false,
		      'checked'		=> $this->get_var('info','campaign','occasional'),
		      'default'		=> $this->get_var('campaign_occasional','default'))),

	    	$form->text(array('desc'	=> $this->bbf('fm_campaign_start'),
				  'name'	=> 'campaign[start]',
				  'labelid'	=> 'campaign-start',
				  'size'	=> 20,
				  'default'	=> $this->get_var('element','campaign','start','default'),
				  'value'	=> $this->get_var('info','campaign','start'),
				  'error'	=> $this->bbf_args('error',
	    	...
	    	$form->text(array('desc'	=> $this->bbf('fm_campaign_end'),
				  ...
				  'labelid'	=> 'campaign-end',
					'size'	=> 20,
				  'default'	=> $this->get_var('element','campaign','end','default'),
				  'value'	=> $this->get_var('info','campaign','end'),
				  'error'	=> $this->bbf_args('error',
...
<?php
		...
		echo	'<div class="txt-center">',
			$url->href_html($this->bbf('create_agent'),
					'callcenter/registrationcampaign/agents',
					'act=add'),
			'</div>';
	endif;
?>
...
<?php
		...
		echo	'<div class="txt-center">',
			$url->href_html($this->bbf('create_queue'),
					'callcenter/registrationcampaign/queues',
					'act=add'),
			'</div>';
	endif;
?>
...
<?php
	echo $form->checkbox(array('desc'	=> $this->bbf('fm_campaign_filter_way_in'),
		      ...
		      'labelid'		=> 'campaign_filter_way_in',
				  ...
				  'required'	=> false,
		      'checked'		=> $this->get_var('info','filters','way','in'),
		      'default'		=> $this->get_var('element','campaign_filter_way_in','default'))),
		    ...
		    $form->checkbox(array('desc'	=> $this->bbf('fm_campaign_filter_way_out'),
		      ...
		      'labelid'		=> 'campaign_filter_way_out',
				  ...
				  'required'	=> false,
		      'checked'		=> $this->get_var('info','filters','way','out'),
					'default'		=> $this->get_var('element','campaign_filter_way_out','default')));
?>
