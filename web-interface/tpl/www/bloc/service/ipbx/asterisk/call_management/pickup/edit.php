...
?>
<div id="sr-pickup" class="b-infos b-form">
	<h3 class="sb-top xspan">
		<span class="span-left">&nbsp;</span>
		<span class="span-center"><?=$this->bbf('title_content_name');?><font><?=$info['pickup']['name']?></font></span>
		<span class="span-right">&nbsp;</span>
	</h3>

<?php
	$this->file_include('bloc/service/ipbx/asterisk/call_management/pickup/submenu');
?>
...
<?php
	$this->file_include('bloc/service/ipbx/asterisk/call_management/pickup/form');
?>
