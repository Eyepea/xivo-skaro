...
?>
<form action="#" name="fm-pickup-list" method="post" accept-charset="utf-8">
<?php
...
?>
	<tr class="sb-content">
		<td colspan="4" class="td-single"><?=$this->bbf('no_pickup');?></td>
	</tr>
<?php
	else:
		for($i = 0;$i < $nb;$i++):
...
?>
	<tr onmouseover="this.tmp = this.className; this.className = 'sb-content l-infos-over';"
		...
		<td class="td-left">
			<?=$form->checkbox(array('name'		=> 'pickups[]',
						 'value'	=> $ref['id'],
						 'label'	=> false,
						 'id'		=> 'it-pickups-'.$i,
						 'checked'	=> false,
		...
		<td class="txt-left" title="<?=dwho_alttitle($ref['name']);?>">
			<label for="it-pickups-<?=$i?>" id="lb-schedules-<?=$i?>">
<?php
