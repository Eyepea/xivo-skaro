...
$page = $url->pager($pager['pages'],
		    ...
		    $pager['prev'],
		    $pager['next'],
		    'service/ipbx/call_center/queueskillsrules',
		    array('act' => $act,$param));
...
?>
<form action="#" name="fm-queueskillrules-list" method="post" accept-charset="utf-8">
<?php
...
<table id="table-main-listing" cellspacing="0" cellpadding="0" border="0">
	<tr class="sb-top">
		...
		<th class="th-center"><?=$this->bbf('col_rule');?></th>
...
?>
	<tr class="sb-content">
		<td colspan="5" class="td-single"><?=$this->bbf('no_queueskillrules');?></td>
	</tr>
<?php
	else:
		for($i = 0;$i < $nb;$i++):
...
?>
	<tr onmouseover="this.tmp = this.className; this.className = 'sb-content l-infos-over';"
		...
		<td class="td-left">
			<?=$form->checkbox(array('name'		=> 'queueskillrules[]',
						 'value'	=> $ref['id'],
						 'label'	=> false,
						 'id'		=> 'it-skills-'.$i,
						 'checked'	=> false,
