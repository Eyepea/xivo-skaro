...
?>
<form action="#" name="fm-paging" method="post" accept-charset="utf-8">
<?php
...
?>
	<tr class="sb-content">
		<td colspan="5" class="td-single"><?=$this->bbf('no_paging');?></td>
	</tr>
<?php
	else:
		for($i = 0;$i < $nb;$i++):
...
?>
	<tr onmouseover="this.tmp = this.className; this.className = 'sb-content l-infos-over';"
		...
		<td class="td-left">
			<?=$form->checkbox(array('name'		=> 'pagings[]',
						 'value'	=> $ref['id'],
						 'label'	=> false,
						 'id'		=> 'it-pagings-'.$i,
						 'checked'	=> false,
		...
		<td class="txt-left">
			<label for="it-pagings-<?=$i?>" id="lb-pagings-<?=$i?>">
<?php
