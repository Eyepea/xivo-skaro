...
if($context_list !== false):
    ...
    $form->checkbox(array('desc'  => $this->bbf('fm_messagewrap'),
              ...
              'checked' => $this->get_var('info','messagewrap','var_val'),
...
if($context_list !== false):
    ...
    $form->text(array('desc'  => $this->bbf('fm_listen-control-forward-key'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','listen-control-forward-key','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_listen-control-reverse-key'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','listen-control-reverse-key','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_listen-control-pause-key'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','listen-control-pause-key','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_listen-control-restart-key'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','listen-control-restart-key','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_listen-control-stop-key'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','listen-control-stop-key','var_val'),
...
<?php
    ...
    $form->select(array('desc'  => $this->bbf('fm_tz'),
            ...
            'selected' => $this->get_var('info','tz','var_val'),
...
<?php
    ...
    $form->select(array('desc'  => $this->bbf('fm_minpassword'),
            ...
            'selected' => $this->get_var('info','minpassword','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_externpassnotify'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','externpassnotify','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_externpasscheck'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','externpasscheck','var_val'),
    ...
    $form->checkbox(array('desc'  => $this->bbf('fm_pollmailboxes'),
              ...
              'checked' => $this->get_var('info','pollmailboxes','var_val'),
    ...
    $form->select(array('desc'  => $this->bbf('fm_pollfreq'),
            ...
            'selected' => $this->get_var('info','pollfreq','var_val'),
    ...
    $form->checkbox(array('desc'  => $this->bbf('fm_imapgreetings'),
              ...
              'checked' => $this->get_var('info','imapgreetings','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_greetingsfolder'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','greetingsfolder','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_imapparentfolder'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','imapparentfolder','var_val'),
    ...
    $form->checkbox(array('desc'  => $this->bbf('fm_hidefromdir'),
              ...
              'checked' => $this->get_var('info','hidefromdir','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_directoryintro'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','directoryintro','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_vm-password'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','vm-password','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_vm-newpassword'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','vm-newpassword','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_vm-passchanged'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','vm-passchanged','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_vm-reenterpassword'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','vm-reenterpassword','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_vm-mistmatch'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','vm-mistmatch','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_vm-invalid-password'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','vm-invalid-password','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_vm-pls-try-again'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','vm-pls-try-again','var_val'),
    ...
    $form->text(array('desc'  => $this->bbf('fm_backupdeleted'),
            ...
            'required' => false,
            'value'    => $this->get_var('info','backupdeleted','var_val'),
    ...
    $form->checkbox(array('desc'  => $this->bbf('fm_smdienable'),
              ...
              'checked' => $this->get_var('info','smdienable','var_val'),
    ...
    $form->checkbox(array('desc'  => $this->bbf('fm_moveheard'),
              ...
              'checked' => $this->get_var('info','moveheard','var_val'),
    ...
    $form->checkbox(array('desc'  => $this->bbf('fm_forward_urgent_auto'),
              ...
              'checked' => $this->get_var('info','forward_urgent_auto','var_val'),
