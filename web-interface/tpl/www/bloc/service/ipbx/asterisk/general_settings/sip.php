...
<?php
    ...
    $form->text(array('desc'  => $this->bbf('fm_externtcpport'),
            ...
            'size'     => 5,
            'help'     => $this->bbf('hlp_fm_externtcpport'),
            'required' => false,
            'value'    => $this->get_var('info','externtcpport','var_val'),
            'default'  => $element['externtcpport']['default'],
            'error'    => $this->bbf_args('error',
        $this->get_var('error', 'externtcpport')) )),

    $form->text(array('desc'  => $this->bbf('fm_externtlsport'),
            'name'     => 'externtlsport',
            'labelid'  => 'externtlsport',
            'size'     => 5,
            'help'     => $this->bbf('hlp_fm_externtlsport'),
            'required' => false,
            'value'    => $this->get_var('info','externtlsport','var_val'),
            'default'  => $element['externtlsport']['default'],
            'error'    => $this->bbf_args('error',
        $this->get_var('error', 'externtlsport')) )),
...
<?php
    ...
    $form->text(array('desc'  => $this->bbf('fm_media_address'),
            'name'     => 'media_address',
            'labelid'  => 'media_address',
            'size'     => 20,
            'help'     => $this->bbf('hlp_fm_media_address'),
            'required' => false,
            'value'    => $this->get_var('info','media_address','var_val'),
            'default'  => $element['media_address']['default'],
            'error'    => $this->bbf_args('error',
        $this->get_var('error', 'media_address')) )),
...
if($moh_list !== false):
	...
	echo	$form->text(array('desc'	=> $this->bbf('fm_vmexten'),
     ...
     $form->select(array('desc'  => $this->bbf('fm_sendrpid'),
            'name'    => 'sendrpid',
            'labelid' => 'sendrpid',
            'key'   => false,
            'bbf'   => 'fm_sendrpid-opt',
            ...
            'selected'  => $this->get_var('info','sendrpid','var_val'),
            'default' => $element['sendrpid']['default']),
         $element['sendrpid']['value']),
