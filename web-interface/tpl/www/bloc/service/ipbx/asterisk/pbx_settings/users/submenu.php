...
<div class="sb-smenu">
	<ul>
		...
		<li id="dwsm-tab-2"
		    class="dwsm-blur"
		    onclick="dwho_submenu.select(this,'sb-part-lines');"
		    onmouseout="dwho_submenu.blur(this);"
		    onmouseover="dwho_submenu.focus(this);">
			<div class="tab">
				<span class="span-center">
					<a href="#lines"><?=$this->bbf('smenu_lines');?></a></span>
			</div>
			<span class="span-right">&nbsp;</span>
		</li>
		<li id="dwsm-tab-3"
		    class="dwsm-blur"
		    onclick="dwho_submenu.select(this,'sb-part-dialaction');"
		    onmouseout="dwho_submenu.blur(this);"
		    onmouseover="dwho_submenu.focus(this);">
			<div class="tab">
				<span class="span-center">
					<a href="#dialaction"><?=$this->bbf('smenu_dialaction');?></a></span>
			</div>
			<span class="span-right">&nbsp;</span>
		</li>
<?php /*
...
*/ ?>
		<li id="dwsm-tab-4"
			...
			<div class="tab">
				<span class="span-center">
					<a href="#service"><?=$this->bbf('smenu_services');?></a></span>
			</div>
			<span class="span-right">&nbsp;</span>
		</li>
		<li id="dwsm-tab-5"
			...
			<div class="tab">
				<span class="span-center">
					<a href="#voicemail"><?=$this->bbf('smenu_voicemail');?></a></span>
			</div>
			<span class="span-right">&nbsp;</span>
		</li>
		<li id="dwsm-tab-6"
