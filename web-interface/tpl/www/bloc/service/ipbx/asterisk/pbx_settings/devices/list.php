...
<?=$form->hidden(array('name' => 'linked','value' => ''))?>
...
?>
		...
		<th class="th-center"><?=$this->bbf('col_linked');?></th>
...
?>
	<tr class="sb-content">
		<td colspan="7" class="td-single"><?=$this->bbf('no_device');?></td>
	</tr>
<?php
	else:
		for($i = 0;$i < $nb;$i++):
...
?>
		...
		<td><?=$this->bbf('device_protocol-'.$ref['protocol']);?></td>
		<td><?=(dwho_has_len($ref['name']) === true ? $ref['name'] : '-')?></td>
		<td><?=(dwho_has_len($ref['linked']) === true ? $ref['linked'] : '-')?></td>
