...
$toolbar_js = array();
$toolbar_js[] = 'var xivo_toolbar_form_name = \'fm-user-list\';';
$toolbar_js[] = 'var xivo_toolbar_form_list = \'userselection[]\';';
...
<div class="sb-advanced-menu">
	<ul id="toolbar-advanced-menu">
		<li>
			<a href="#" id="toolbar-advanced-menu-enable">
				<?=$this->bbf('toolbar_adv_menu_enable');?>
			</a>
		</li>
		<li>
			<a href="#" id="toolbar-advanced-menu-disable">
				<?=$this->bbf('toolbar_adv_menu_disable');?>
			</a>
		</li>
		<li>
