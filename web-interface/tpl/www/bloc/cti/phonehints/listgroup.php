...
?>
<div id="sr-ctiphonehintsgroup" class="b-list">
<?php
	if($page !== ''):
		echo '<div class="b-page">',$page,'</div>';
	endif;
?>
<form action="#" name="fm-ctiphonehintsgroup-list" method="post" accept-charset="utf-8">
<?php
...
<table id="table-main-listing">
	<tr class="sb-top">
		...
		<th class="th-center"><?=$this->bbf('col_phonehintsgroup');?></th>
...
?>
	<tr class="sb-content">
		<td colspan="5" class="td-single"><?=$this->bbf('no_phonehintsgroup');?></td>
	</tr>
<?php
	else:
		for($i = 0;$i < $nb;$i++):
...
?>
	<tr onmouseover="this.tmp = this.className; this.className = 'sb-content l-infos-over';"
		...
		<td class="td-left">
			<?=$form->checkbox(array('name'		=> 'phonehintsgroups[]',
						 'value'	=> $ref['ctiphonehintsgroup']['id'],
						 'label'	=> false,
						 'id'		=> 'it-phonehintsgroups-'.$i,
						 'checked'	=> false,
						 'paragraph'	=> false));?>
		</td>
...
?>
		...
		<td align="left"><?=dwho_trunc($ref['ctiphonehintsgroup']['description'],40,'...',false)?></td>
...
<?php
		...
		if($ref['ctiphonehintsgroup']['deletable'] == 1):
